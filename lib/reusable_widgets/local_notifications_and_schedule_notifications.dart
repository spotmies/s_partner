...
//   static void displayAwesomeNotification(RemoteMessage message) async {
...
// void displayAwesomeNotifications(BuildContext context) async {
//   final int id = DateTime.now().millisecondsSinceEpoch ~/ 1000;
//   final String timeZone =
//       await AwesomeNotifications().getLocalTimeZoneIdentifier();
//   await AwesomeNotifications().createNotification(
...
//     log('first step');
//     if (receivedNotifiction.channelKey == 'cancel') {
//       log('second step');
